...
- IB Chat has no docked chat webview; sessions live in the **Chats** sidebar tree and each session opens a **WebviewPanel** editor tab. The IB Chat activity bar icon opens `workbench.view.ibChatContainer`.
