...
- IB Chat has no docked chat webview; sessions live in the **Chats** sidebar tree and each session opens a **WebviewPanel** editor tab. **Show IB Chat** runs `workbench.view.ibChatContainer` to reveal the sidebar container.
