...
1. When you encounter something that took a very long time add the shortcut to solving it to `Shortcuts` in the `AGENTS.md`
2. Always make sure to verify changes with command `npm run verify` before finishing
